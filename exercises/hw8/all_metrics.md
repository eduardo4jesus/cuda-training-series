Device NVIDIA GeForce RTX 3070 Laptop GPU (GA104)
--------------------------------------------------------------------------- --------------- --------------- ----------------------------------------------------------------------
...
lts__t_requests_aperture_device_evict_normal_demote_lookup_miss             Counter         request         # of LTS requests accessing device memory (vidmem) marked             
...
lts__t_requests_aperture_sysmem_op_membar_evict_normal_demote               Counter         request         # of LTS requests accessing system memory (sysmem) for memory         
                                                                                                            barriers marked evict-normal-demote                                   
lts__t_requests_aperture_sysmem_op_membar_evict_normal_demote_lookup_hit    Counter         request         # of LTS requests accessing system memory (sysmem) for memory         
                                                                                                            barriers marked evict-normal-demote that hit                          
...
lts__t_requests_op_atom_evict_normal_demote                                 Counter         request         # of LTS requests for all atomics marked evict-normal-demote          
lts__t_requests_op_atom_evict_normal_demote_lookup_hit                      Counter         request         # of LTS requests for all atomics marked evict-normal-demote that hit 
lts__t_requests_op_atom_evict_normal_demote_lookup_miss                     Counter         request         # of LTS requests for all atomics marked evict-normal-demote that     
                                                                                                            missed                                                                
...
lts__t_requests_op_membar_evict_normal_demote_lookup_hit                    Counter         request         # of LTS requests for memory barriers marked evict-normal-demote that 
                                                                                                            hit                                                                   
lts__t_requests_op_membar_evict_normal_demote_lookup_miss                   Counter         request         # of LTS requests for memory barriers marked evict-normal-demote that 
                                                                                                            missed                                                                
...
lts__t_requests_op_read_evict_normal_demote_lookup_hit                      Counter         request         # of LTS requests for reads marked evict-normal-demote that hit       
lts__t_requests_op_read_evict_normal_demote_lookup_miss                     Counter         request         # of LTS requests for reads marked evict-normal-demote that missed    
...
lts__t_requests_op_write_evict_normal_demote_lookup_hit                     Counter         request         # of LTS requests for writes marked evict-normal-demote that hit      
lts__t_requests_op_write_evict_normal_demote_lookup_miss                    Counter         request         # of LTS requests for writes marked evict-normal-demote that missed   
...
lts__t_requests_srcnode_gpc_aperture_device_evict_normal_demote             Counter         request         # of LTS requests from node GPC accessing device memory (vidmem)      
                                                                                                            marked evict-normal-demote                                            
lts__t_requests_srcnode_gpc_aperture_device_evict_normal_demote_lookup_hit  Counter         request         # of LTS requests from node GPC accessing device memory (vidmem)      
                                                                                                            marked evict-normal-demote that hit                                   
lts__t_requests_srcnode_gpc_aperture_device_evict_normal_demote_lookup_miss Counter         request         # of LTS requests from node GPC accessing device memory (vidmem)      
                                                                                                            marked evict-normal-demote that missed                                
...
lts__t_requests_srcnode_gpc_aperture_peer_evict_normal_demote               Counter         request         # of LTS requests from node GPC accessing peer memory (peermem)       
                                                                                                            marked evict-normal-demote                                            
lts__t_requests_srcnode_gpc_aperture_peer_evict_normal_demote_lookup_hit    Counter         request         # of LTS requests from node GPC accessing peer memory (peermem)       
                                                                                                            marked evict-normal-demote that hit                                   
lts__t_requests_srcnode_gpc_aperture_peer_evict_normal_demote_lookup_miss   Counter         request         # of LTS requests from node GPC accessing peer memory (peermem)       
                                                                                                            marked evict-normal-demote that missed                                
...
lts__t_requests_srcnode_gpc_aperture_sysmem_evict_normal_demote             Counter         request         # of LTS requests from node GPC accessing system memory (sysmem)      
                                                                                                            marked evict-normal-demote                                            
lts__t_requests_srcnode_gpc_aperture_sysmem_evict_normal_demote_lookup_hit  Counter         request         # of LTS requests from node GPC accessing system memory (sysmem)      
                                                                                                            marked evict-normal-demote that hit                                   
lts__t_requests_srcnode_gpc_aperture_sysmem_evict_normal_demote_lookup_miss Counter         request         # of LTS requests from node GPC accessing system memory (sysmem)      
                                                                                                            marked evict-normal-demote that missed                                
...
lts__t_requests_srcnode_gpc_op_atom_evict_normal                            Counter         request         # of LTS requests from node GPC for all atomics marked evict-normal   
                                                                                                            (LRU)                                                                 
lts__t_requests_srcnode_gpc_op_atom_evict_normal_demote                     Counter         request         # of LTS requests from node GPC for all atomics marked                
                                                                                                            evict-normal-demote                                                   
lts__t_requests_srcnode_gpc_op_atom_evict_normal_demote_lookup_hit          Counter         request         # of LTS requests from node GPC for all atomics marked                
                                                                                                            evict-normal-demote that hit                                          
lts__t_requests_srcnode_gpc_op_atom_evict_normal_demote_lookup_miss         Counter         request         # of LTS requests from node GPC for all atomics marked                
                                                                                                            evict-normal-demote that missed                                       
...
lts__t_requests_srcnode_gpc_op_membar_evict_normal_demote                   Counter         request         # of LTS requests from node GPC for memory barriers marked            
                                                                                                            evict-normal-demote                                                   
lts__t_requests_srcnode_gpc_op_membar_evict_normal_demote_lookup_hit        Counter         request         # of LTS requests from node GPC for memory barriers marked            
                                                                                                            evict-normal-demote that hit                                          
lts__t_requests_srcnode_gpc_op_membar_evict_normal_demote_lookup_miss       Counter         request         # of LTS requests from node GPC for memory barriers marked            
                                                                                                            evict-normal-demote that missed                                       
...
lts__t_requests_srcnode_gpc_op_read_evict_normal_demote_lookup_hit          Counter         request         # of LTS requests from node GPC for reads marked evict-normal-demote  
                                                                                                            that hit                                                              
lts__t_requests_srcnode_gpc_op_read_evict_normal_demote_lookup_miss         Counter         request         # of LTS requests from node GPC for reads marked evict-normal-demote  
                                                                                                            that missed                                                           
...
lts__t_requests_srcnode_gpc_op_write_evict_normal_demote_lookup_hit         Counter         request         # of LTS requests from node GPC for writes marked evict-normal-demote 
                                                                                                            that hit                                                              
lts__t_requests_srcnode_gpc_op_write_evict_normal_demote_lookup_miss        Counter         request         # of LTS requests from node GPC for writes marked evict-normal-demote 
                                                                                                            that missed                                                           
...
lts__t_requests_srcunit_l1_aperture_device_evict_normal_demote              Counter         request         # of LTS requests from unit L1 accessing device memory (vidmem)       
                                                                                                            marked evict-normal-demote                                            
lts__t_requests_srcunit_l1_aperture_device_evict_normal_demote_lookup_hit   Counter         request         # of LTS requests from unit L1 accessing device memory (vidmem)       
                                                                                                            marked evict-normal-demote that hit                                   
lts__t_requests_srcunit_l1_aperture_device_evict_normal_demote_lookup_miss  Counter         request         # of LTS requests from unit L1 accessing device memory (vidmem)       
                                                                                                            marked evict-normal-demote that missed                                
...
lts__t_requests_srcunit_l1_aperture_peer_evict_normal_demote                Counter         request         # of LTS requests from unit L1 accessing peer memory (peermem) marked 
                                                                                                            evict-normal-demote                                                   
lts__t_requests_srcunit_l1_aperture_peer_evict_normal_demote_lookup_hit     Counter         request         # of LTS requests from unit L1 accessing peer memory (peermem) marked 
                                                                                                            evict-normal-demote that hit                                          
lts__t_requests_srcunit_l1_aperture_peer_evict_normal_demote_lookup_miss    Counter         request         # of LTS requests from unit L1 accessing peer memory (peermem) marked 
                                                                                                            evict-normal-demote that missed                                       
...
lts__t_requests_srcunit_l1_aperture_sysmem_evict_normal_demote              Counter         request         # of LTS requests from unit L1 accessing system memory (sysmem)       
                                                                                                            marked evict-normal-demote                                            
lts__t_requests_srcunit_l1_aperture_sysmem_evict_normal_demote_lookup_hit   Counter         request         # of LTS requests from unit L1 accessing system memory (sysmem)       
                                                                                                            marked evict-normal-demote that hit                                   
lts__t_requests_srcunit_l1_aperture_sysmem_evict_normal_demote_lookup_miss  Counter         request         # of LTS requests from unit L1 accessing system memory (sysmem)       
                                                                                                            marked evict-normal-demote that missed                                
...
lts__t_requests_srcunit_l1_op_atom_evict_normal                             Counter         request         # of LTS requests from unit L1 for all atomics marked evict-normal    
                                                                                                            (LRU)                                                                 
lts__t_requests_srcunit_l1_op_atom_evict_normal_demote                      Counter         request         # of LTS requests from unit L1 for all atomics marked                 
                                                                                                            evict-normal-demote                                                   
lts__t_requests_srcunit_l1_op_atom_evict_normal_demote_lookup_hit           Counter         request         # of LTS requests from unit L1 for all atomics marked                 
                                                                                                            evict-normal-demote that hit                                          
lts__t_requests_srcunit_l1_op_atom_evict_normal_demote_lookup_miss          Counter         request         # of LTS requests from unit L1 for all atomics marked                 
                                                                                                            evict-normal-demote that missed                                       
...
lts__t_requests_srcunit_l1_op_membar_evict_normal_demote                    Counter         request         # of LTS requests from unit L1 for memory barriers marked             
                                                                                                            evict-normal-demote                                                   
lts__t_requests_srcunit_l1_op_membar_evict_normal_demote_lookup_hit         Counter         request         # of LTS requests from unit L1 for memory barriers marked             
                                                                                                            evict-normal-demote that hit                                          
lts__t_requests_srcunit_l1_op_membar_evict_normal_demote_lookup_miss        Counter         request         # of LTS requests from unit L1 for memory barriers marked             
                                                                                                            evict-normal-demote that missed                                       
...
lts__t_requests_srcunit_l1_op_read_evict_normal_demote_lookup_hit           Counter         request         # of LTS requests from unit L1 for reads marked evict-normal-demote   
                                                                                                            that hit                                                              
lts__t_requests_srcunit_l1_op_read_evict_normal_demote_lookup_miss          Counter         request         # of LTS requests from unit L1 for reads marked evict-normal-demote   
                                                                                                            that missed                                                           
...
lts__t_requests_srcunit_l1_op_write_evict_normal_demote_lookup_hit          Counter         request         # of LTS requests from unit L1 for writes marked evict-normal-demote  
                                                                                                            that hit                                                              
lts__t_requests_srcunit_l1_op_write_evict_normal_demote_lookup_miss         Counter         request         # of LTS requests from unit L1 for writes marked evict-normal-demote  
                                                                                                            that missed                                                           
...
lts__t_requests_srcunit_tex_aperture_device_evict_normal_demote             Counter         request         # of LTS requests from unit TEX accessing device memory (vidmem)      
                                                                                                            marked evict-normal-demote                                            
lts__t_requests_srcunit_tex_aperture_device_evict_normal_demote_lookup_hit  Counter         request         # of LTS requests from unit TEX accessing device memory (vidmem)      
                                                                                                            marked evict-normal-demote that hit                                   
lts__t_requests_srcunit_tex_aperture_device_evict_normal_demote_lookup_miss Counter         request         # of LTS requests from unit TEX accessing device memory (vidmem)      
                                                                                                            marked evict-normal-demote that missed                                
...
lts__t_requests_srcunit_tex_aperture_peer_evict_normal_demote               Counter         request         # of LTS requests from unit TEX accessing peer memory (peermem)       
                                                                                                            marked evict-normal-demote                                            
lts__t_requests_srcunit_tex_aperture_peer_evict_normal_demote_lookup_hit    Counter         request         # of LTS requests from unit TEX accessing peer memory (peermem)       
                                                                                                            marked evict-normal-demote that hit                                   
lts__t_requests_srcunit_tex_aperture_peer_evict_normal_demote_lookup_miss   Counter         request         # of LTS requests from unit TEX accessing peer memory (peermem)       
                                                                                                            marked evict-normal-demote that missed                                
...
lts__t_requests_srcunit_tex_aperture_sysmem_evict_normal_demote             Counter         request         # of LTS requests from unit TEX accessing system memory (sysmem)      
                                                                                                            marked evict-normal-demote                                            
lts__t_requests_srcunit_tex_aperture_sysmem_evict_normal_demote_lookup_hit  Counter         request         # of LTS requests from unit TEX accessing system memory (sysmem)      
                                                                                                            marked evict-normal-demote that hit                                   
lts__t_requests_srcunit_tex_aperture_sysmem_evict_normal_demote_lookup_miss Counter         request         # of LTS requests from unit TEX accessing system memory (sysmem)      
                                                                                                            marked evict-normal-demote that missed                                
...
lts__t_requests_srcunit_tex_op_atom_evict_normal                            Counter         request         # of LTS requests from unit TEX for all atomics marked evict-normal   
                                                                                                            (LRU)                                                                 
lts__t_requests_srcunit_tex_op_atom_evict_normal_demote                     Counter         request         # of LTS requests from unit TEX for all atomics marked                
                                                                                                            evict-normal-demote                                                   
lts__t_requests_srcunit_tex_op_atom_evict_normal_demote_lookup_hit          Counter         request         # of LTS requests from unit TEX for all atomics marked                
                                                                                                            evict-normal-demote that hit                                          
lts__t_requests_srcunit_tex_op_atom_evict_normal_demote_lookup_miss         Counter         request         # of LTS requests from unit TEX for all atomics marked                
                                                                                                            evict-normal-demote that missed                                       
...
lts__t_requests_srcunit_tex_op_membar_evict_normal_demote                   Counter         request         # of LTS requests from unit TEX for memory barriers marked            
                                                                                                            evict-normal-demote                                                   
lts__t_requests_srcunit_tex_op_membar_evict_normal_demote_lookup_hit        Counter         request         # of LTS requests from unit TEX for memory barriers marked            
                                                                                                            evict-normal-demote that hit                                          
lts__t_requests_srcunit_tex_op_membar_evict_normal_demote_lookup_miss       Counter         request         # of LTS requests from unit TEX for memory barriers marked            
                                                                                                            evict-normal-demote that missed                                       
...
lts__t_requests_srcunit_tex_op_read_evict_normal_demote_lookup_hit          Counter         request         # of LTS requests from unit TEX for reads marked evict-normal-demote  
                                                                                                            that hit                                                              
lts__t_requests_srcunit_tex_op_read_evict_normal_demote_lookup_miss         Counter         request         # of LTS requests from unit TEX for reads marked evict-normal-demote  
                                                                                                            that missed                                                           
...
lts__t_requests_srcunit_tex_op_write_evict_normal_demote_lookup_hit         Counter         request         # of LTS requests from unit TEX for writes marked evict-normal-demote 
                                                                                                            that hit                                                              
lts__t_requests_srcunit_tex_op_write_evict_normal_demote_lookup_miss        Counter         request         # of LTS requests from unit TEX for writes marked evict-normal-demote 
                                                                                                            that missed                                                           
...
lts__t_sectors_aperture_device_op_atom_evict_normal                         Counter         sector          # of LTS sectors accessing device memory (vidmem) for all atomics     
                                                                                                            marked evict-normal (LRU)                                             
lts__t_sectors_aperture_device_op_atom_evict_normal_demote                  Counter         sector          # of LTS sectors accessing device memory (vidmem) for all atomics     
                                                                                                            marked evict-normal-demote                                            
lts__t_sectors_aperture_device_op_atom_evict_normal_demote_lookup_hit       Counter         sector          # of LTS sectors accessing device memory (vidmem) for all atomics     
                                                                                                            marked evict-normal-demote that hit                                   
lts__t_sectors_aperture_device_op_atom_evict_normal_demote_lookup_miss      Counter         sector          # of LTS sectors accessing device memory (vidmem) for all atomics     
                                                                                                            marked evict-normal-demote that missed                                
...
lts__t_sectors_aperture_peer_op_atom_evict_normal                           Counter         sector          # of LTS sectors accessing peer memory (peermem) for all atomics      
                                                                                                            marked evict-normal (LRU)                                             
lts__t_sectors_aperture_peer_op_atom_evict_normal_demote                    Counter         sector          # of LTS sectors accessing peer memory (peermem) for all atomics      
                                                                                                            marked evict-normal-demote                                            
lts__t_sectors_aperture_peer_op_atom_evict_normal_demote_lookup_hit         Counter         sector          # of LTS sectors accessing peer memory (peermem) for all atomics      
                                                                                                            marked evict-normal-demote that hit                                   
lts__t_sectors_aperture_peer_op_atom_evict_normal_demote_lookup_miss        Counter         sector          # of LTS sectors accessing peer memory (peermem) for all atomics      
                                                                                                            marked evict-normal-demote that missed                                
...
lts__t_sectors_aperture_sysmem_op_atom_evict_normal                         Counter         sector          # of LTS sectors accessing system memory (sysmem) for all atomics     
                                                                                                            marked evict-normal (LRU)                                             
lts__t_sectors_aperture_sysmem_op_atom_evict_normal_demote                  Counter         sector          # of LTS sectors accessing system memory (sysmem) for all atomics     
                                                                                                            marked evict-normal-demote                                            
lts__t_sectors_aperture_sysmem_op_atom_evict_normal_demote_lookup_hit       Counter         sector          # of LTS sectors accessing system memory (sysmem) for all atomics     
                                                                                                            marked evict-normal-demote that hit                                   
lts__t_sectors_aperture_sysmem_op_atom_evict_normal_demote_lookup_miss      Counter         sector          # of LTS sectors accessing system memory (sysmem) for all atomics     
                                                                                                            marked evict-normal-demote that missed                                
...
lts__t_sectors_op_atom_evict_normal_demote                                  Counter         sector          # of LTS sectors for all atomics marked evict-normal-demote           
lts__t_sectors_op_atom_evict_normal_demote_lookup_hit                       Counter         sector          # of LTS sectors for all atomics marked evict-normal-demote that hit  
lts__t_sectors_op_atom_evict_normal_demote_lookup_miss                      Counter         sector          # of LTS sectors for all atomics marked evict-normal-demote that      
                                                                                                            missed                                                                
...
lts__t_sectors_srcnode_gpc_op_atom_evict_normal                             Counter         sector          # of LTS sectors from node GPC for all atomics marked evict-normal    
                                                                                                            (LRU)                                                                 
lts__t_sectors_srcnode_gpc_op_atom_evict_normal_demote                      Counter         sector          # of LTS sectors from node GPC for all atomics marked                 
                                                                                                            evict-normal-demote                                                   
lts__t_sectors_srcnode_gpc_op_atom_evict_normal_demote_lookup_hit           Counter         sector          # of LTS sectors from node GPC for all atomics marked                 
                                                                                                            evict-normal-demote that hit                                          
lts__t_sectors_srcnode_gpc_op_atom_evict_normal_demote_lookup_miss          Counter         sector          # of LTS sectors from node GPC for all atomics marked                 
                                                                                                            evict-normal-demote that missed                                       
...
lts__t_sectors_srcunit_l1_op_atom_evict_normal                              Counter         sector          # of LTS sectors from unit L1 for all atomics marked evict-normal     
                                                                                                            (LRU)                                                                 
lts__t_sectors_srcunit_l1_op_atom_evict_normal_demote                       Counter         sector          # of LTS sectors from unit L1 for all atomics marked                  
                                                                                                            evict-normal-demote                                                   
lts__t_sectors_srcunit_l1_op_atom_evict_normal_demote_lookup_hit            Counter         sector          # of LTS sectors from unit L1 for all atomics marked                  
                                                                                                            evict-normal-demote that hit                                          
lts__t_sectors_srcunit_l1_op_atom_evict_normal_demote_lookup_miss           Counter         sector          # of LTS sectors from unit L1 for all atomics marked                  
                                                                                                            evict-normal-demote that missed                                       
...
lts__t_sectors_srcunit_tex_op_atom_evict_normal                             Counter         sector          # of LTS sectors from unit TEX for all atomics marked evict-normal    
                                                                                                            (LRU)                                                                 
lts__t_sectors_srcunit_tex_op_atom_evict_normal_demote                      Counter         sector          # of LTS sectors from unit TEX for all atomics marked                 
                                                                                                            evict-normal-demote                                                   
lts__t_sectors_srcunit_tex_op_atom_evict_normal_demote_lookup_hit           Counter         sector          # of LTS sectors from unit TEX for all atomics marked                 
                                                                                                            evict-normal-demote that hit                                          
lts__t_sectors_srcunit_tex_op_atom_evict_normal_demote_lookup_miss          Counter         sector          # of LTS sectors from unit TEX for all atomics marked                 
                                                                                                            evict-normal-demote that missed                                       
...
sm__inst_executed_pipe_cbu_pred_on_any                                      Counter         inst            # of warp instructions executed by cbu pipe with at least 1 thread    
                                                                                                            predicated on                                                         
sm__inst_executed_pipe_fma                                                  Counter         inst            # of warp instructions executed by fma pipes                          
sm__inst_executed_pipe_fma_type_fp16                                        Counter         inst            # of warp instructions executed by fma pipes (fp16 ops)               
sm__inst_executed_pipe_fmaheavy                                             Counter         inst            # of warp instructions executed by fmaheavy pipe                      
sm__inst_executed_pipe_fmalite                                              Counter         inst            # of warp instructions executed by fmalite pipe                       
sm__inst_executed_pipe_fp64                                                 Counter         inst            # of warp instructions executed by fp64 pipe                          
sm__inst_executed_pipe_fp64_op_dmma                                         Counter         inst            # of warp instructions executed by fp64 pipe (DMMA ops)               
sm__inst_executed_pipe_fp64_op_dmma_pred_off_all                            Counter         inst            # of warp instructions executed by fp64 pipe (DMMA ops) with all      
                                                                                                            threads predicated off                                                
sm__inst_executed_pipe_fp64_op_dmma_pred_on_any                             Counter         inst            # of warp instructions executed by fp64 pipe (DMMA ops) with at least 
                                                                                                            1 thread predicated on                                                
sm__inst_executed_pipe_fp64_op_fp64                                         Counter         inst            # of warp instructions executed by fp64 pipe (fp64 ops)               
sm__inst_executed_pipe_fp64_op_fp64_pred_off_all                            Counter         inst            # of warp instructions executed by fp64 pipe (fp64 ops) with all      
                                                                                                            threads predicated off                                                
sm__inst_executed_pipe_fp64_op_fp64_pred_on_any                             Counter         inst            # of warp instructions executed by fp64 pipe (fp64 ops) with at least 
                                                                                                            1 thread predicated on                                                
sm__inst_executed_pipe_fp64_pred_off_all                                    Counter         inst            # of warp instructions executed by fp64 pipe with all threads         
                                                                                                            predicated off                                                        
sm__inst_executed_pipe_fp64_pred_on_any                                     Counter         inst            # of warp instructions executed by fp64 pipe with at least 1 thread   
                                                                                                            predicated on                                                         
...
sm__pipe_fma_cycles_active                                                    Counter         cycle           # of cycles where fma pipes were active                               
sm__pipe_fmaheavy_cycles_active                                               Counter         cycle           # of cycles where fmaheavy pipe was active                            
sm__pipe_fmalite_cycles_active                                                Counter         cycle           # of cycles where fmalite pipe was active                             
...
sm__thread_inst_executed_pipe_alu_pred_on                                     Counter         inst            # of thread instructions executed by alu where guard predicate was    
                                                                                                              true                                                                  
sm__thread_inst_executed_pipe_fma_pred_on                                     Counter         inst            # of thread instructions executed by fma pipe where guard predicate   
                                                                                                              was true                                                              
sm__thread_inst_executed_pipe_fma_type_fp16_pred_on                           Counter         inst            # of thread instructions executed by fma_type_fp16 where guard        
                                                                                                              predicate was true                                                    
sm__thread_inst_executed_pipe_fmaheavy_pred_on                                Counter         inst            # of thread instructions executed by fmaheavy pipe where guard        
                                                                                                              predicate was true                                                    
sm__thread_inst_executed_pipe_fmalite_pred_on                                 Counter         inst            # of thread instructions executed by fmalite pipe where guard         
                                                                                                              predicate was true                                                    
...
sm__warps_active_shader_cs                                                    Counter         warp            cumulative # of active CS warps                                       
...
smsp__average_inst_executed_pipe_fma_type_fp16_per_warp                       Ratio           inst/warp       average # of instructions executed by pipe fma_type_fp16 per warp     
smsp__average_inst_executed_pipe_fmaheavy_per_warp                            Ratio           inst/warp       average # of instructions executed by pipe fmaheavy per warp          
smsp__average_inst_executed_pipe_fmalite_per_warp                             Ratio           inst/warp       average # of instructions executed by pipe fmalite per warp           
smsp__average_inst_executed_pipe_fp64_op_dmma_per_warp                        Ratio           inst/warp       average # of instructions executed by pipe fp64_op_dmma per warp      
smsp__average_inst_executed_pipe_fp64_op_fp64_per_warp                        Ratio           inst/warp       average # of instructions executed by pipe fp64_op_fp64 per warp      
...
smsp__average_warp_latency_issue_stalled_long_scoreboard_pipe_l1tex           Ratio           inst/warp       average # of warp cycles spent waiting for a scoreboard dependency on 
                                                                                                              non-RTCORE L1TEX (local, global, surface, tex) operation              
...
smsp__average_warp_latency_issue_stalled_mio_throttle                         Ratio           inst/warp       average # of warp cycles spent waiting for a free entry in the MIO    
                                                                                                              instruction queue                                                     
smsp__average_warp_latency_issue_stalled_mio_throttle_pipe_mio                Ratio           inst/warp       average # of warp cycles spent waiting for a free entry in the        
                                                                                                              non-RTCORE pipe of MIO instruction queue                              
...
smsp__average_warps_issue_stalled_long_scoreboard_pipe_l1tex_per_issue_active Ratio           inst            average # of warps resident per issue cycle, waiting for a scoreboard 
                                                                                                              dependency on non-RTCORE L1TEX (local, global, surface, tex)          
                                                                                                              operation                                                             
...
smsp__average_warps_issue_stalled_mio_throttle_pipe_mio_per_issue_active      Ratio           inst            average # of warps resident per issue cycle, waiting for a free entry 
                                                                                                              in the non-RTCORE pipe of MIO instruction queue                       
...
smsp__inst_executed_pipe_cbu_pred_on_any                                    Counter         inst            # of warp instructions executed by cbu pipe with at least 1 thread    
                                                                                                            predicated on                                                         
smsp__inst_executed_pipe_fma                                                Counter         inst            # of warp instructions executed by fma pipes                          
smsp__inst_executed_pipe_fma_type_fp16                                      Counter         inst            # of warp instructions executed by fma pipes (fp16 ops)               
smsp__inst_executed_pipe_fmaheavy                                           Counter         inst            # of warp instructions executed by fmaheavy pipe                      
smsp__inst_executed_pipe_fmalite                                            Counter         inst            # of warp instructions executed by fmalite pipe                       
smsp__inst_executed_pipe_fp64                                               Counter         inst            # of warp instructions executed by fp64 pipe                          
smsp__inst_executed_pipe_fp64_op_dmma                                       Counter         inst            # of warp instructions executed by fp64 pipe (DMMA ops)               
smsp__inst_executed_pipe_fp64_op_dmma_pred_off_all                          Counter         inst            # of warp instructions executed by fp64 pipe (DMMA ops) with all      
                                                                                                            threads predicated off                                                
smsp__inst_executed_pipe_fp64_op_dmma_pred_on_any                           Counter         inst            # of warp instructions executed by fp64 pipe (DMMA ops) with at least 
                                                                                                            1 thread predicated on                                                
smsp__inst_executed_pipe_fp64_op_fp64                                       Counter         inst            # of warp instructions executed by fp64 pipe (fp64 ops)               
smsp__inst_executed_pipe_fp64_op_fp64_pred_off_all                          Counter         inst            # of warp instructions executed by fp64 pipe (fp64 ops) with all      
                                                                                                            threads predicated off                                                
smsp__inst_executed_pipe_fp64_op_fp64_pred_on_any                           Counter         inst            # of warp instructions executed by fp64 pipe (fp64 ops) with at least 
                                                                                                            1 thread predicated on                                                
smsp__inst_executed_pipe_fp64_pred_off_all                                    Counter         inst            # of warp instructions executed by fp64 pipe with all threads         
                                                                                                              predicated off                                                        
smsp__inst_executed_pipe_fp64_pred_on_any                                     Counter         inst            # of warp instructions executed by fp64 pipe with at least 1 thread   
                                                                                                              predicated on                                                         
...
smsp__pipe_fma_cycles_active                                                  Counter         cycle           # of cycles where fma pipes were active                               
smsp__pipe_fmaheavy_cycles_active                                             Counter         cycle           # of cycles where fmaheavy pipe was active                            
smsp__pipe_fmalite_cycles_active                                              Counter         cycle           # of cycles where fmalite pipe was active                             
...
smsp__thread_inst_executed_pipe_alu_pred_on                                               Counter         inst            # of thread instructions executed by alu where guard predicate was    
                                                                                                                          true                                                                  
smsp__thread_inst_executed_pipe_fma_pred_on                                               Counter         inst            # of thread instructions executed by fma pipe where guard predicate   
                                                                                                                          was true                                                              
smsp__thread_inst_executed_pipe_fma_type_fp16_pred_on                                     Counter         inst            # of thread instructions executed by fma_type_fp16 where guard        
                                                                                                                          predicate was true                                                    
smsp__thread_inst_executed_pipe_fmaheavy_pred_on                                          Counter         inst            # of thread instructions executed by fmaheavy pipe where guard        
                                                                                                                          predicate was true                                                    
smsp__thread_inst_executed_pipe_fmalite_pred_on                                           Counter         inst            # of thread instructions executed by fmalite pipe where guard         
                                                                                                                          predicate was true                                                    
...
smsp__warp_issue_stalled_long_scoreboard_per_warp_active                                  Ratio                           proportion of warps per cycle, waiting for a scoreboard dependency on 
                                                                                                                          L1TEX (local, global, surface, tex) operation                         
smsp__warp_issue_stalled_long_scoreboard_pipe_l1tex_per_warp_active                       Ratio                           proportion of warps per cycle, waiting for a scoreboard dependency on 
                                                                                                                          non-RTCORE L1TEX (local, global, surface, tex) operation              
...
smsp__warp_issue_stalled_mio_throttle_per_warp_active                                     Ratio                           proportion of warps per cycle, waiting for a free entry in the MIO    
                                                                                                                          instruction queue                                                     
smsp__warp_issue_stalled_mio_throttle_pipe_mio_per_warp_active                            Ratio                           proportion of warps per cycle, waiting for a free entry in the        
                                                                                                                          non-RTCORE pipe of MIO instruction queue                              
...
smsp__warps_issue_stalled_long_scoreboard_pipe_l1tex                        Counter         warp            cumulative # of warps waiting for a scoreboard dependency on          
                                                                                                            non-RTCORE L1TEX (local, global, surface, tex) operation              
...
smsp__warps_issue_stalled_mio_throttle                                      Counter         warp            cumulative # of warps waiting for a free entry in the MIO instruction 
                                                                                                            queue                                                                 
smsp__warps_issue_stalled_mio_throttle_pipe_mio                             Counter         warp            cumulative # of warps waiting for a free entry in the non-RTCORE pipe 
                                                                                                            of MIO instruction queue                                              
...
tpc__average_registers_per_thread                                           Ratio           register/thread average # of registers per thread                                     
tpc__average_registers_per_thread_shader_cs                                 Ratio           register/thread average # of registers per thread, for CS warps                       
...
tpc__sm_rf_registers_allocated                                              Counter         register        cumulative # of registers allocated                                   
tpc__sm_rf_registers_allocated_realtime                                     Counter         register        cumulative # of registers allocated                                   
...
tpc__warps_active_realtime                                                  Counter         warp            cumulative # of warps in flight                                       
